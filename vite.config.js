  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'docs/webcontainer-migration': resolve(__dirname, 'docs/webcontainer-migration.html'),
        ...
        'examples/vue-real-vite-demo': resolve(__dirname, 'examples/vue-real-vite-demo.html'),
      },
    },
    outDir: 'dist-site',
  },
